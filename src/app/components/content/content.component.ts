  ...
  listProjects: project[] = [
    {
      ...
      name: 'Clon Spotify',
      description: `Clon de spotify implementando un API de prueba, reproductor y vista
      como home, busqueda y favoritos`,
      skills: [this.listSkills[6], this.listSkills[7], this.listSkills[2]],
      gitHub: 'https://github.com/Eduardo347387/ClonSpotify',
      liveSite: 'https://clonspotify37283.netlify.app'
    },
    {
